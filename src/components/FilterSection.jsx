...
const FilterSection = () => {
  ...
  return (
    <div className='sm:flex justify-between items-center mb-16 mt-12 '>
      <div className='flex items-center shadow-[3px_3px_10px_-2px_rgba(0,0,0,0.3)] pl-4 bg-lightest dark:bg-primaryD animate-slideLeft'>
      ...
      <select
        ...
        className='text-[20px] py-4 pl-4 pr-16 shadow-[3px_3px_10px_-2px_rgba(0,0,0,0.3)] border-0 sm:mt-0 mt-4 dark:bg-primaryD dark:text-lightest animate-slideRight'
      >
